...
namespace ClemsonCommuteMVVM
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private List<Route> buildObjectGraph()
        {
            ...
            stops1.Add(new Stop() { DepartureTime = (DateTime.Now), Location = new Location() { Latitude = 34.815534F, Longitude = -82.325498F } }); //ICAR

            stops1.Add(new Stop() { DepartureTime = (DateTime.Now), Location = new Location() { Latitude = 34.675874F, Longitude = -82.834545F } }); //McAdams


            stops2.Add(new Stop() { DepartureTime = (DateTime.Now), Location = new Location() { Latitude = 34.815534F, Longitude = -82.325498F } }); //ICAR

            stops2.Add(new Stop() { DepartureTime = (DateTime.Now), Location = new Location() { Latitude = 34.850975F, Longitude = -82.398995F } }); //Greenville One-Clemson
            ...
            stops3.Add(new Stop() { DepartureTime = (DateTime.Now), Location = new Location() { Latitude = 34.675874F, Longitude = -82.834545F } }); //McAdams


            stops3.Add(new Stop() { DepartureTime = (DateTime.Now), Location = new Location() { Latitude = 34.673101F, Longitude = -82.829540F } }); //C-1 Parking Lot
